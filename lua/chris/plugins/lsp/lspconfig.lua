...
return {
	...
	dependencies = {
		...
		"williamboman/mason-lspconfig.nvim", -- reuiqre mason
	...
	config = function()
		...
		-- only make they keymaps when an lsp is attached and active during the buffer
		...
		-- you can configure your LSP's here and change default settings
		local servers = {
			-- clangd = {}, -- the C lsp
			-- gopls = {},
			pyright = {
